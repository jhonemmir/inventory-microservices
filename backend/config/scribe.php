...
return [
    ...
    'description' => 'API REST para sistema de inventario con predicción de stock mediante IA. Arquitectura de microservicios con Laravel (backend), Python (AI Worker), RabbitMQ (mensajería), Redis (caché) y MySQL (base de datos).',
